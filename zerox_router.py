...
class ZeroXAggregator:
    ...
    def _get_quote(self, sell_token: str, buy_token: str, sell_amount: int, 
        ...
        try:
            params = {
                ...
                "slippagePercentage": str(slippage / 100),
            }
            ...
            if response.status_code == 200:
                ...
                print(f"[dim]0x API error: {response.status_code} - {error_text}[/dim]")
                return None
    ...
    def swap_eth_for_tokens(self, token_address: str, amount_eth: Decimal, 
        ...
        try:
            ...
            print(f"[dim]0x route found, expected output: {quote.get('buyAmount', 'N/A')}[/dim]")
